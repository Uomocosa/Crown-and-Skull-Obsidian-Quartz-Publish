...
Roll D20 at or below that skill’s listed value to succeed. 
...
When attacked, the GM will ask you to roll Defense. 
Roll at or below this value to avoid injury from the incoming attack. An enemy stat, ATK, will act as a penalty to reduce Defense rolls. 
...
This roll can use a wide variety of dice. Add the total rolled for damage inflicted. This roll can be reduced by an enemy stat called DEF.
