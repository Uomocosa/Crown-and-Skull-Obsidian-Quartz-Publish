...
| `d12`      | ITEM            | NOTE                                                                              | COST      |
| ---------- | --------------- | --------------------------------------------------------------------------------- | --------- |
| ***`1`***  | **Plumed Helmet**   | ***+3** [[Armor and Defense\|Defense]], enrages enemies*                          | **3 pts** |
| ***`2`***  | **Silver Shield**   | ***+6** [[Armor and Defense\|Defense]], repel lycanthrope attacks w/no roll*      | **3 pts** |
...
| ***`7`***  | **Beads of Lurian** | *If facing fear or panic, gain **+5** [[Skills#^magic\|Magic skill]]*             | **3 pts** |
| ***`8`***  | **Great Bear Pelt** | *Ignore penalties from cold or snow*                                              | **3 pts** |
| ***`9`***  | **Giant Sword**     | *A `3d12` blade with **+2** [[Armor and Defense\|Defense]]*                       | **3 pts** |
| ***`10`*** | **Song of Ullur**   | *Roll [[Skills#^magic\|Magic]] to heal all allies **1** [[Attrition\|attrition]]* | **3 pts** |
